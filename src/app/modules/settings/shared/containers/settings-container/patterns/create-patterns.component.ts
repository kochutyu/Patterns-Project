...
import {selectCreatePatternsPipe} from "../../../../../../core/store/selectors/settings/create-pattern.selectors";
...
export class CreatePatternsComponent {
  ...
  public createPatterns$: Observable<IBlockCategoryList> = this._store.pipe(selectCreatePatternsPipe);
